...
<html>
<head>
    <title>Permohonan Diteruskan ke PTIK</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">Permohonan Telah Diteruskan</div>
        <p>Halo PTIK,</p>
        <p>Permohonan peminjaman barang <strong>{{ $itemName }}</strong> telah diteruskan oleh <strong>{{ $forwardedBy }}</strong>.</p>
        <p>Waktu diteruskan: <strong>{{ $forwardedAt }}</strong></p>
        <p>Silakan buka sistem untuk menindaklanjuti permohonan ini.</p>
    </div>
    <div class="footer">
